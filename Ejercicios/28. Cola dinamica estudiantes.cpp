...
void cEst::setNombre(char *newNomb){
...
void casos()
{
  ...
  cColaDin oColaDin;
  cEst *ptrEst;
   cout<<"COLA DINAMICA CON PUNTERO A VOID ESTUDIANTE\n";
   do
   {
      clrscr();
   	int op=menu();
      ...
      {
      	case 1:
         	cout<<"AGREGAR DE ESTUDIANTE \n";
            cout<<"Ingrese el estudiante a ser insertado \n";
            ptrEst=new cEst;
            ptrEst->leerDatEst();
         ...
         case 2:
            ...
            cout<<"Los datos del estudinate que se han eliminado son \n";
            ptrEst->verDatEst();
             }
            else
            {
